...
This feedback could be used to fine-tune the model to produce more accurate, fluid or generally desirable descriptions of proteins, as has been done for document summarization models \citet{finetuningWithHuman, learningToSummarize}.
...
%\end{center}
%Of note is the command \verb+\citett+, which produces citations appropriate for
%use in inline text.  For example,
%\begin{verbatim}
%   \citett{hasselmo} investigated\dots
%\end{verbatim}
%produces
%\begin{quote}
...
%previous work [4].'' If you citet your other papers that are not widely available
